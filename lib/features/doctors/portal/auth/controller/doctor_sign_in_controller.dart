...
import '../../../../users/auth/data/models/user_model.dart';
...
class DoctorSignInController extends BaseRequestController {
  ...
  String _resolveRoleRoute(Map result) {
    ...
    // );
    return AppRoutesName.rDoctorPortal;
  }

  bool _isRoleCompatible(Map result) {
    final AuthRole apiRole = AuthRole.fromValue(
      result['data']?['user']?['role']?.toString(),
    );
