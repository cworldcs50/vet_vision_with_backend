      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CircleAvatar(
                radius: AdaptiveLayout.getResponsiveFontSize(context, fontSize: 20),
              ...
              SizedBox(width: AdaptiveLayout.getResponsiveFontSize(context, fontSize: 10)),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
              ...
              Row(
                children: review.starsList.map((isFilled) => Icon(
          ...
          if (review.comment != null && review.comment!.isNotEmpty) ...[
            SizedBox(height: AdaptiveLayout.getResponsiveFontSize(context, fontSize: 10)),
            Text(
              review.comment!,
              style: TextStyle(
